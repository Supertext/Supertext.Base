...
namespace Supertext.Base.IdentityServer4.AccessTokenValidation
{
    /// <summary>
    ...
    public class IdentityServerAuthenticationHandler : AuthenticationHandler<IdentityServerAuthenticationOptions>
    {
        ...
        {
            if (Context.Items.TryGetValue(IdentityServerAuthenticationDefaults.EffectiveSchemeKey + Scheme.Name, out var value))
            {
