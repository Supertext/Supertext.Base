...
public interface IDecentralizedCache
{
    ...
    /// <param name="key">A string identifying the requested value.</param>
    /// <param name="value">The value to set in the cache.</param>
    /// <param name="absoluteExpirationRelativeToNow">Expiration of the value</param>
    void Set(string key, byte[] value, TimeSpan absoluteExpirationRelativeToNow);
    ...
    void SetString(string key, string value, TimeSpan absoluteExpirationRelativeToNow);

    Task SetStringAsync(string key, string value, CancellationToken token = default);

    Task SetStringAsync(string key, string value, TimeSpan absoluteExpirationRelativeToNow, CancellationToken token = default);
}